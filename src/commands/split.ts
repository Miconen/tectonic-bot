...
class split {
    ...
    async split(
        ...
        const msg = `${interaction.user.username} has submitted a request for ${value} points. Please wait for admin approval and make sure you have posted a screenshot of your drop as proof.`;
